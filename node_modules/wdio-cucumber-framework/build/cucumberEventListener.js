...
var CucumberEventListener = exports.CucumberEventListener = function (_get__2) {
    ...
    function CucumberEventListener(eventBroadcaster) {
        ...
        eventBroadcaster.on('gherkin-document', _this.onGherkinDocument.bind(_this)).on('pickle-accepted', _this.onPickleAccepted.bind(_this)).on('test-step-started', _this.onTestStepStarted.bind(_this)).on('test-step-finished', _this.onTestStepFinished.bind(_this)).on('test-case-finished', _this.onTestCaseFinished.bind(_this)).on('test-run-finished', _this.onTestRunFinished.bind(_this));
        return _this;
    }
    ...
    (0, _createClass3.default)(CucumberEventListener, [{
        ...
        value: function onTestStepStarted(testStepStartedEvent) {
            ...
            var step = scenario.steps[testStepStartedEvent.index];
        ...
        value: function onTestStepFinished(testStepFinishedEvent) {
            ...
            var step = scenario.steps[testStepFinishedEvent.index];
